...
void loop() {
  ...
  if(update_orientation)
  {
    ...
    double angle_error = roll_setpoint - orientation.get_roll()*180/PI;
    double roll_rate_setpoint = kr*angle_error;
    
    double error = roll_rate_setpoint - roll_rate;
    double roll_pid = 0;
