...
double kp_pitch = 0;//3.859;
double ki_pitch = 0;//3.203;
double kd_pitch = 0;//0.638;
...
void loop() {
  ...
  if(update_orientation)
  {
    ...
    {
      // Roll PID
      double roll_error = roll_setpoint - roll_rate;
      ...
      // Pitch PID
      double pitch_error = pitch_setpoint - pitch_rate;
      ...
      // Yaw PID
      double yaw_error = yaw_setpoint - yaw_rate;
